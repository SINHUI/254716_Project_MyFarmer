...
$signed= hash_hmac('sha256', $signing, 'S-Mi4knANZ849u_oB2tVWc8Q');
if ($signed === $data['x_signature']) {
    ...
    if ($paidstatus == "Success"){
        ...
        <td>'.date("h:i a").'</td></tr></table><br><p><center>Press back button to return to MyFarmer</center></p></div></body>';
