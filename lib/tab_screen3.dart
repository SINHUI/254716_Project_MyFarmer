...
class _TabScreen3State extends State<TabScreen3> {
  ...
  Future<String> makeRequest() async {
    String urlLoadGoods = "http://lastyeartit.com//myFarmer/php/load_accepted_goods.php";
    ProgressDialog pr = new ProgressDialog(context,
        type: ProgressDialogType.Normal, isDismissible: false);
    pr.style(message: "Loading All Selected Goods");
    pr.show();
  ...
  Future init() async {
    if (widget.user.email=="user@noregister"){
      Toast.show("Please register to view shopping cart", context,
