...
String urlUpload = "http://lastyeartit.com//myFarmer/php/register_user.php";
File _image;
        ...
        Column _buildBottomNavigationMenu(){
          ...
          children: <Widget>[
            ListTile(
              ...
              onTap:() async {_image = await ImagePicker.pickImage(source: ImageSource.camera,imageQuality: 80,maxHeight: 450,maxWidth:double.infinity);
              setState(() {
              ...
              onTap:() async {_image = await ImagePicker.pickImage(source:ImageSource.gallery,imageQuality: 80,maxHeight: 450,maxWidth: double.infinity);
              setState(() {
